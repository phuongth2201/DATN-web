...
import hospital.config.SecurityConfiguration;
import hospital.config.SecurityJwtConfiguration;
import hospital.config.WebConfigurer;
import hospital.management.SecurityMetersService;
import hospital.web.rest.AuthenticateController;
