...
public class SecurityConfiguration {
    ...
    @Bean
    public SecurityFilterChain filterChain(HttpSecurity http, MvcRequestMatcher.Builder mvc, RateLimitingFilter rateLimitingFilter)
        throws Exception {
        http
            .cors(withDefaults())
            ...
            .authorizeHttpRequests(authz ->
                ...
                authz
                    ...
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/specialties")).permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/hospitals")).permitAll()
